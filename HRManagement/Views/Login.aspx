<%@ Page Language="C#" Inherits="HRManagement.Views.Login" %>
<!DOCTYPE html>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to HRManagement! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>
              <form id="login_form" class="mb-3" runat="server">
                <div class="mb-3">
                  <label for="email" class="form-label">Email or Username</label>
                  <input type="text" class="form-control" id="email" name="email-username" placeholder="Enter your email or username" runat="server" autofocus />
                </div>
                <div><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="email" ErrorMessage="Please Enter Your Email or Username" ForeColor="Red"></asp:RequiredFieldValidator></div>                                
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="password" id="password" class="form-control" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" runat="server" aria-describedby="password" />
                    <span class="input-group-text cursor-pointer">
                      <i class="bx bx-hide"></i>
                    </span>
                  </div>
                </div>
                <div><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="password" ErrorMessage="Please Enter Your Password" ForeColor="Red"></asp:RequiredFieldValidator></div>                                    
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <asp:Button class="btn btn-primary d-grid w-100" Text="Sign in" id="submit_form" runat="server" OnClick="SignInButtonClick"/>
                </div>
                <div><asp:Label ID="ErrorLabel" runat="server"></asp:Label></div>
              </form>
              <p class="text-center">
